        ...
        if mode == "LIVE":
            ...
            try:
                ...
                if res.status_code == 200 and data.get('rt_cd') == '0':
                    record_trade(ticker, name, action, current_price, quantity, f"[LIVE-{mode_type}] {reason}")
            ...
            record_trade(ticker, name, action, current_price, quantity, f"[PAPER-{mode_type}] {reason}")
